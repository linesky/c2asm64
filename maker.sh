...
mkdir /tmp/examples
nasm -f elf32 -o /tmp/dlib.a dlib.asm
nasm -f elf32 -o /tmp/libc.o clib.asm
gcc -shared -o /tmp/dlib.so.0.1 /tmp/dlib.a -nostdlib
gcc -o /tmp/my  /tmp/libc.o duseit.c -ldl
